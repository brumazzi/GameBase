...
namespace game{
    ...
    namespace physic{
        ...
        namespace body{
            b2BodyId& create(std::string world, std::string bodyName, game::Object* object, sf::Vector2f position, sf::Vector2f size, b2BodyType type = b2_staticBody, float density = 1.0, float friction = 0.0, float restitution = 0.0, bool fixRotation = true);
